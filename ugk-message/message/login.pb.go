...
type HeartRequest struct {
	...
	ClientTime float64 `protobuf:"fixed64,1,opt,name=clientTime,proto3" json:"clientTime,omitempty"` //客户端时间 ，用于计算ping
}
...
func (x *HeartRequest) GetClientTime() float64 {
	if x != nil {
		return x.ClientTime
	}
	return 0
...
type HeartResponse struct {
	...
	ClientTime float64 `protobuf:"fixed64,1,opt,name=clientTime,proto3" json:"clientTime,omitempty"` //客户端时间
}
...
func (x *HeartResponse) GetClientTime() float64 {
	if x != nil {
		return x.ClientTime
	}
	return 0
...
var file_login_proto_rawDesc = []byte{
	...
	0x79, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x2e, 0x0a, 0x0c, 0x48, 0x65, 0x61,
	0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1e, 0x0a, 0x0a, 0x63, 0x6c, 0x69,
	0x65, 0x6e, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0a, 0x63,
	0x6c, 0x69, 0x65, 0x6e, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x2f, 0x0a, 0x0d, 0x48, 0x65, 0x61,
	0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x63, 0x6c,
	0x69, 0x65, 0x6e, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0a,
	0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x44, 0x0a, 0x0c, 0x4c, 0x6f,
