...
func InitConfigAndLog() {
	//1.配置文件路径
	configPath := flag.String("config", "/Users/jzy/Work/Go/ugk-server/ugk-game/game-galactic-kittens/galactic-kittens-match/config/app_config_develop.json", "配置文件加载路径")
	flag.Parse()
	FilePath = *configPath
	BaseConfig.Reload()
