...
namespace Common.Network.Sync
{
    ...
    public abstract class NetworkTransform : MonoBehaviour
    {
        ...
        protected virtual void OnClientToServerSync(Vector3? position, Quaternion? rotation, Vector3? scale)
        {
            ...
            if (onlySyncOnChange &&
                NeedsCorrection(snapshots, connectionToClient.remoteTimeStamp,
            ...
            AddSnapshot(snapshots, connectionToClient.remoteTimeStamp + timeStampAdjustment + offset, position,
                rotation, scale);
        }
