...
const (
	...
	ClientHeartInterval   = time.Second * 10 //客户端心跳时间  //Unity 默认超时为10s，最大重连次数为10次 https://docs-multiplayer.unity3d.com/netcode/current/learn/bossroom/optimizing-bossroom/#disconnect-timeout
	ServerHeartInterval   = time.Minute * 10 //客户端心跳时间
	KcpRetransmissionTime = 50               //kcp超时重传时间
)
